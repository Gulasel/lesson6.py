# # " БД-База Данных"
# # "СУДБ-Система управление базой данных "
...
# #     is_activ=bool(input("Принятия соглашения о конфедициальности"))
...
# #     cursor.execute("""INSERT INTO instagram
# #                   ( full_name,username,age,birth_date,raiting,is_activ)
# #                    VALUES('{fulname}','?','?','?','?','?')""",full_name,username,age,birth_date,raiting,is_activ)
